  ...
  return (
    <div className="min-h-screen pb-20">
      ...
      <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
        <a href="">
         <img src={logo} className="h-11 w-auto" alt="" />
        </a>
      ...
      <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
        ...
        <div className="flex items-center gap-4 ">
          <Link
            to="/app"
            className="bg-blue-500 shadow-2xl shadow-black hover:shadow-blue-500 hover:bg-blue-600 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-blue-400 flex items-center transition-colors"
          >
            Get started
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <button className="flex shadow-2xl shadow-indigo-300 items-center gap-2 border border-slate-400 hover:bg-blue-50 transition rounded-full px-7 h-12 text-slate-700">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
