...
const Testimonial = () => {
 ...
 const cardsData = [
            ...
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-1">
                        <p>{card.name}</p>
                        <svg className="mt-0.5 fill-blue-600" width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div id="testimonials" className="flex items-center mt-10 md:mt-0 flex-col">
      <div className="flex items-center gap-2 text-sm text-blue-600 bg-blue-400/10 rounded-full px-6 py-1.5">
        <BookUser className="stroke-blue-600" size={18} />
      ...
      ></Title>
       <>
        ...
        `}</style>
            ...
            <div className="marquee-row mt-5 w-full mx-auto max-w-5xl overflow-hidden relative">
